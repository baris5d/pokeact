...
export const PokemonDetail = () => {
    ...
    return (
        <div className="pokemon-detail">
            {Object.keys(collectedPokemon).length && data && (
                <div
                ...
                >
                    ...
                    <div className="pokemon-detail__info">
                        <h2>
                            <span className="bold">
                                #{formatNumber(collectedPokemon.id.toString())}
                            </span>
                        </h2>
                        <h1 className="poke_name">
                            {kebabCaseToTitleCase(collectedPokemon.name)}
                        </h1>
                        <div className="pokemon-detail__types-wrapper">
                            {collectedPokemon.types.map((item, index) => {
                                return (
                                    <div
                        ...
                        <div className="pokemon-detail__description">
                            <p>
                                ...
                                {dmToFtAndIn(collectedPokemon.height)}
                            </p>
                            <p>
                                <span className="bold">Weight:</span>{' '}
                                {hgToKg(collectedPokemon.weight)}
                            </p>
                        </div>
                        <PokemonDetailStats
                        ...
                        {['double_damage_to', 'double_damage_from'].map(
                            (prop, index) => {
                                return (
                                    <PokemonTypes
